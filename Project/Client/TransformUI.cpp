...
void TransformUI::render_update()
{
	...
	ImGui::Text("World Position : %f, %f, %f", GetTargetObject()->Transform()->GetWorldPos().x, GetTargetObject()->Transform()->GetWorldPos().y, GetTargetObject()->Transform()->GetWorldPos().z);
