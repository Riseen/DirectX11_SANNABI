...
void Inspector::CreateComponentUI()
{
	...
	m_arrComUI[(UINT)COMPONENT_TYPE::RIGIDBODY]->Deactivate();
	AddChildUI(m_arrComUI[(UINT)COMPONENT_TYPE::RIGIDBODY]);

	m_arrComUI[(UINT)COMPONENT_TYPE::GRAVITY] = new GravityUI;
	m_arrComUI[(UINT)COMPONENT_TYPE::GRAVITY]->Deactivate();
	AddChildUI(m_arrComUI[(UINT)COMPONENT_TYPE::GRAVITY]);
}
