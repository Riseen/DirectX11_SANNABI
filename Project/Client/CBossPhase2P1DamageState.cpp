...
CBossPhase2P1DamageState::CBossPhase2P1DamageState()
	: m_fDownTime(1.7f)
	, m_fAccTime(0.f)
{
}
...
void CBossPhase2P1DamageState::finaltick()
{
...
void CBossPhase2P1DamageState::Enter()
{
}

void CBossPhase2P1DamageState::Exit()
{
	m_fAccTime = 0.f;
